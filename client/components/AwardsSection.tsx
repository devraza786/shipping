const awards = [
  {
    year: "2025",
    title: "Best International Shipping Partner",
    description: "For outstanding service, reliability, and customs clearance expertise",
    org: "Maritime Excellence Awards",
  ...
  {
    year: "2024",
    title: "Top Import/Export Service Provider",
    description: "For innovative customs solutions and seamless global trade facilitation.",
    org: "International Trade Association",
  ...
  {
    year: "2025",
    title: "Sustainability in Maritime Award",
    description: "Leading the industry with eco-friendly shipping practices and compliance standards.",
    org: "Green Shipping Initiative",
  ...
  },
  {
    ...
    description: "For exceptional reliability, communication, and on-time shipment delivery.",
    org: "Royaume Shipping Line Clients",
